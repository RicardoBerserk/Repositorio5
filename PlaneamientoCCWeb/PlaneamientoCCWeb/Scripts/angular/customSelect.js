(function (angular, undefined) {
    ...
    var module = angular.module('Customizar', []);

    module.value('customSelectDefaults', {
        displayText: 'Todos',
        emptyListText: 'No existen items para mostrarlos',
        emptySearchResultText: 'No se encontro el item buscado',
        addText: 'Add',
        searchDelay: 300
    });
    ...
    module.directive('customSelect', ['$parse', '$compile', '$timeout', '$q', 'customSelectDefaults', function ($parse, $compile, $timeout, $q, baseOptions) {
        ...
        return {
            ...
            link: function (scope, elem, attrs, controller) {
                ...
                function getOptions() {
                    baseOptions.displayText = valorTipo || baseOptions.displayText;
